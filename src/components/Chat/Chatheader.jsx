...
const ChatHeader = ({ roomTitle, onLeave, onDelete }) => {
  return (
    <div className="flex flew-row justify-between fixed top-0 left-0 right-0 z-50 bg-white shadow-md p-3 items-center mb-3">
      <button
        onClick={onLeave}
        className=" text-black rounded justify-self-start w-10"
      >
        &lt;
      </button>
